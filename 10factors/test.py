...
def get_dv(start = 20170101,end = 20180101): 
    ...
    #define
    factor_list  = ['turnover_ratio','volume','turnover']
...
from Tamplate import alpha1,alpha2,alpha3,alpha4,alpha5,alpha6,alpha7,alpha8,alpha9,alpha10

for f in ['alpha'+str(i+1) for i in range(10)]:
